...
export default class TaskManager extends Component {
  ...
  initTaskManager = () => {
    ...
    let generalTasks = [
      new ReadingTask({ title: "ReadingTask 1", topic: "Allgemein"}),
    ...
    let csTasks = [
      ...
      new InteractiveTask({ title: "InteractiveTask Informatik 1", topic: "Informatik" })
    ]
    let avTasks = [
      new ReadingTask({ title: "ReadingTask AV 1", topic: "Audiovisuelle Medien" }),
      new QuizTask({ title: "QuizTask AV 1", topic: "Audiovisuelle Medien" }),
      new InteractiveTask({ title: "InteractiveTask AV 1", topic: "Audiovisuelle Medien" })
    ]
    let gdTasks = [
      new ReadingTask({ title: "ReadingTask GD 1", topic: "Graphische Datenverarbeitung" }),
      new QuizTask({ title: "QuizTask GD 1", topic: "Graphische Datenverarbeitung" }),
      new InteractiveTask({ title: "InteractiveTask GD 1", topic: "Graphische Datenverarbeitung" })
    ]
    let tasksArray = [
